within FromSFCLib.Lab_2021.ProcessComponents;

model dp_lin_opPoint
...
equation
  pwh_a.w + pwh_b.w = 0;
  pwh_a.p-pwh_b.p = dpnom/wnom*pwh_a.w;
  pwh_a.h = inStream(pwh_b.h);
  pwh_b.h = inStream(pwh_a.h);
annotation(
    Icon(graphics = {Text(origin = {2, 3}, lineColor = {238, 238, 236}, extent = {{-54, 49}, {54, -49}}, textString = "wT"), Rectangle(fillColor = {52, 101, 164}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, 38}, {100, -38}}), Text(origin = {-1, 2}, lineColor = {238, 238, 236}, extent = {{-59, 22}, {59, -22}}, textString = "dp lin")}));
end dp_lin_opPoint;