within SFC.BasicBlocks.BaseClasses;
...
protected
  replaceable constant Integer qualifier;
...
algorithm
  ...
  annotation(
    Icon(graphics = {Rectangle(origin = {-170, 0}, fillColor = {238, 238, 236}, fillPattern = FillPattern.Solid, extent = {{-30, 40}, {30, -40}}), Rectangle(origin = {30, 0}, fillColor = {238, 238, 236}, fillPattern = FillPattern.Solid, extent = {{-170, 40}, {170, -40}}), Text(origin = {32, 0}, extent = {{-168, 18}, {168, -18}}, textString = "%action_name", horizontalAlignment = TextAlignment.Left)}, coordinateSystem(extent = {{-200, -100}, {200, 100}})),
