...
model test_cg_002 "SFC - Two separate SFC with the same Cyclic Group with period=1 "
 ...
 SFC.SFCelements.Condition C20_21(y = S20.t > 1.8) annotation(
 ...
 SFC.SFCelements.Condition C21_22(y = S21.t > 0.5) annotation(
 ...
 SFC.SFCelements.Condition C22_20(y = S22.t > 2.1) annotation(
 ...
 SFCelements.Condition condition2(y = S10.t > 1.3) annotation(
 ...
 SFC.SFCelements.Condition condition1(y = S11.t > 1.3) annotation(
