...
model test_sem_TwoPeriod "Two SFC with semaphores with different period"
  SFC.Tests.TestWithCyclicGroup.test_cg_001 test_semaphore_001 annotation(
    Placement(visible = true, transformation(origin = {-30, -10}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  SFC.Tests.TestWithCyclicGroup.test_cg_001 test_semaphore_002(cyclicGroup.period = 0.5)  annotation(
