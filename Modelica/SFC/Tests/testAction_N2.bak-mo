...
model testAction_N2 "Action with N qualifier - connected to a generic Step"
  ...
  SFC.BasicBlocks.Action A(initialStepAction = false, qualifierType = SFC.Types.Qualifier.N) annotation(
...
equation
  ...
  annotation(
    Documentation(info = "<html><head></head><body><div>Action&nbsp;<b>A</b>&nbsp;is connected to Step&nbsp;<u>S1</u>. When S1 becomes active, action A is set and remains set until S1 is deactivated.&nbsp;</div><div><br></div><div><br></div><div><br></div>
    
    <img width=\"400\" src=\"modelica://SFC/Images/Test/N2.png\">
