...
model testAlt2Brach_Problem1 "Alternative Split/Join test with two branches"
  ...
  Modelica.Blocks.Sources.BooleanPulse Cpulse2(period = 4, startTime = 1, width = 30) annotation(
    Placement(visible = true, transformation(origin = {-38, 78}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
equation
