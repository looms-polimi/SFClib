...
model testPar3Branch_Tcnot0 "Parallel Split/Join test with three branches"
  ...
  SFC.BasicBlocks.Transition T7(Tcycle = 1) annotation(
  ...
  SFC.BasicBlocks.Condition C1(y = S0.t > 2) annotation(
    Placement(visible = true, transformation(origin = {44, 61}, extent = {{-22, -11}, {22, 11}}, rotation = 0)));
  ...
  SFC.BasicBlocks.Condition C7(y = Cpulse.y) annotation(
    Placement(visible = true, transformation(origin = {36, -89}, extent = {{-16, -11}, {16, 11}}, rotation = 0)));
...
equation
  ...
  connect(T1.C, C1.y) annotation(
    Line(points = {{12, 62}, {16, 62}, {16, 61}, {20, 61}}, color = {255, 0, 255}));
  connect(T7.C, C7.y) annotation(
    Line(points = {{12, -88}, {15.5, -88}, {15.5, -89}, {18, -89}}, color = {255, 0, 255}));
