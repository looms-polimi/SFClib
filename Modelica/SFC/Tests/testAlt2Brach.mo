...
model testAlt2Brach "Alternative Split/Join test with two branches"
  ...
  Modelica.Blocks.Sources.BooleanPulse Cpulse1(period = 4, startTime = 0.1, width = 30) annotation(
  ...
  Modelica.Blocks.Sources.BooleanPulse Cpulse2(period = 5, startTime = 2, width = 30) annotation(
