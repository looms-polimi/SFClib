...
model testBranchingParallel2 "Parallel Split/Join test with two branches"
...
equation
  connect(A0.actionOUT, A.mergeIN[1]) annotation(
    Line(points = {{24.4, 76}, {38.4, 76}, {38.4, 80}, {84, 80}}));
  connect(A1.actionOUT, A.mergeIN[2]) annotation(
    Line(points = {{-15.6, 14}, {4.4, 14}, {4.4, 30}, {38.4, 30}, {38.4, 80}, {84, 80}}));
  connect(B0.actionOUT, B.mergeIN[1]) annotation(
    Line(points = {{24.4, 64}, {68.4, 64}, {68.4, 16}, {92, 16}}));
  connect(B4.actionOUT, B.mergeIN[2]) annotation(
    Line(points = {{64.4, -34}, {68.4, -34}, {68.4, 16}, {92, 16}}));
  connect(S0.X, B0.phase_active) annotation(
    Line(points = {{-4, 70}, {0, 70}, {0, 64}, {4, 64}, {4, 64}}, color = {255, 0, 255}));
  connect(S0.X, A0.phase_active) annotation(
    Line(points = {{-4, 70}, {0, 70}, {0, 76}, {4, 76}, {4, 76}}, color = {255, 0, 255}));
  connect(S1.X, A1.phase_active) annotation(
    Line(points = {{-44, 14}, {-40, 14}, {-40, 14}, {-36, 14}, {-36, 14}, {-36, 14}, {-36, 14}, {-36, 14}}, color = {255, 0, 255}));
  connect(S4.X, B4.phase_active) annotation(
    Line(points = {{36, -34}, {40, -34}, {40, -34}, {44, -34}, {44, -34}, {44, -34}, {44, -34}, {44, -34}}, color = {255, 0, 255}));
