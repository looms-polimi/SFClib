...
model SystemToMachineStates
  ...
  Modelica.Blocks.Interfaces.BooleanInput IN annotation(
    Placement(visible = true, transformation(origin = {-206, 2}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-80, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
...
equation
  connect(IN, Piece_In.In) annotation(
    Line(points = {{-206, 2}, {-107, 2}}, color = {255, 0, 255}));
