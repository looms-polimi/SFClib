within SFC.DiscreteEventSys.Example_LAB.DTs;
...
model DT_001
  ...
  SFC.SFCelements.Transition T12 annotation(
    Placement(visible = true, transformation(origin = {-82, 90}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
  ...
  SFC.SFCelements.Action action_S5(qualifierType = SFC.Types.Qualifier.R) annotation(
  ...
  Modelica.Blocks.Interfaces.BooleanOutput Out1_Belt annotation(
    Placement(visible = true, transformation(origin = {202, 36}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {231, 69}, extent = {{-31, -31}, {31, 31}}, rotation = 0)));
  Modelica.Blocks.Interfaces.BooleanOutput Out2_xBG1 annotation(
    Placement(visible = true, transformation(origin = {204, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {230, -72}, extent = {{-30, -30}, {30, 30}}, rotation = 0)));
equation
  ...
  connect(T12.OUT, S2.IN) annotation(
    Line(points = {{-82, 88}, {-86, 88}, {-86, 76}, {-80, 76}}));
  connect(T12.C, cond_T12.y) annotation(
    Line(points = {{-68, 90}, {-58, 90}}, color = {255, 0, 255}));
  ...
  connect(S1.OUT, T12.IN) annotation(
    Line(points = {{-80, 106}, {-80, 100}, {-82, 100}, {-82, 92}}));
  ...
  connect(Belt.y, Out1_Belt) annotation(
    Line(points = {{30, 148}, {150, 148}, {150, 38}, {202, 38}, {202, 36}}, color = {255, 0, 255}));
  connect(xBG1.y, Out2_xBG1) annotation(
    Line(points = {{80, 104}, {114, 104}, {114, -2}, {204, -2}, {204, 0}}, color = {255, 0, 255}));
  annotation(
