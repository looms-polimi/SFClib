...
model Cyclic_object_2
  ...
  inner SFCelements.CyclicGroup cyclicGroup(period = 0.5) annotation(
    Placement(visible = true, transformation(origin = {-90, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  SFCelements.Transition T10 annotation(
    Placement(visible = true, transformation(origin = {-10, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.BooleanExpression c10(y = S1.t > 1) annotation(
    Placement(visible = true, transformation(origin = {40, -40}, extent = {{-20, -10}, {20, 10}}, rotation = 180)));
  SFC.SFCelements.N_action an1(action_name = "out2")  annotation(
    Placement(visible = true, transformation(origin = {40, -10}, extent = {{-20, -10}, {20, 10}}, rotation = 0)));
  SFC.SFCio.Read_boolean rb1(variable_name = "cmd12")  annotation(
    Placement(visible = true, transformation(origin = {40, 20}, extent = {{20, -10}, {-20, 10}}, rotation = 0)));
equation
  ...
  connect(T01.C, rb1.y) annotation(
