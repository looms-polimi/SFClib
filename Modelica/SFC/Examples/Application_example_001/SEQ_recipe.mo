...
model SEQ_recipe
  inner SFC.SFCelements.CyclicGroup cyclicGroup(period = 0.25)  annotation(
    Placement(visible = true, transformation(origin = {79, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  SFC.SFCio.Read_integer r_cycles(variable_name = "cycles")  annotation(
    Placement(visible = true, transformation(origin = {121, -50}, extent = {{-20, -10}, {20, 10}}, rotation = 0)));
