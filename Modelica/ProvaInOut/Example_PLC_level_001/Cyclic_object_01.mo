...
model Cyclic_object_01
  ProvaInOut.actions_mgmt.S_action a1s(aname = "relay_cmd_01") annotation(
    Placement(visible = true, transformation(origin = {30, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ProvaInOut.actions_mgmt.R_action a1r(aname = "relay_cmd_01") annotation(
  ...
  Modelica.Blocks.Sources.BooleanExpression c10(y = rg1.value < 0.4) annotation(
    Placement(visible = true, transformation(origin = {40, -40}, extent = {{-20, -10}, {20, 10}}, rotation = 180)));
  Modelica.Blocks.Sources.BooleanExpression c01(y = rg1.value > 0.6) annotation(
    Placement(visible = true, transformation(origin = {40, 20}, extent = {{-20, -10}, {20, 10}}, rotation = 180)));
  actions_mgmt.real_get rg1(name = "process_var_01") annotation(
