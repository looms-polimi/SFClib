within FromSFCLib.DiscreteEventSys.Example_LAB.Observers;
...
equation
  ...
  connect(machineStates.Working_mode, tW) annotation(
    Line(points = {{124, 28}, {124, -18}, {142, -18}, {142, -38}}, color = {255, 0, 255}));
  ...
  connect(machineStates.Idle_mode, tI) annotation(
    Line(points = {{124, 37}, {94, 37}, {94, 28}, {124, 28}, {124, -22}, {142, -22}}, color = {255, 0, 255}));
  connect(machineStates.Fault_mode, tF) annotation(
    Line(points = {{124, 19}, {124, -30.5}, {142, -30.5}, {142, -54}}, color = {255, 0, 255}));
